...
.big-warning b {
	...
	<div id="installer-right">
		...
		<ul class="version-history">
			<li><span class="version">Ver</span> 1.49.12</li>
			<li><span class="version-fixed">Fix</span> In some cases JavaScript functions were being run multiple times when using Conditional Fields, causing delays.</li>
		</ul>
